...
local configpath = uci:get("AdGuardHome", "AdGuardHome", "configpath") or "/etc/AdGuardHome/config.yaml"
...
if not fs.access(binpath) then
	...
	if testtime ~= tonumber(binmtime) or version == nil then
		local tmp = luci.sys.exec(binpath .. " --version | grep -m 1 -E '[0-9]+[.][Bbeta0-9\.\-]+' -o")
...
o.default		= "/etc/AdGuardHome/config.yaml"
o.datatype		= "string"
o.optional		= false
o.rmempty		= false
o.validate		= function(self, value)
